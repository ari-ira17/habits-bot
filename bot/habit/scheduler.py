...
from statistic.send_statistic import send_daily_statistic_if_time, send_weekly_statistic_if_time
...
async def deactivate_habit_if_completed(habit_id: int, bot, user_id: int, habit_name: str):
    ...
    if completion_percentage >= 100:
        ...
        completion_message = (
            ...
            f"Привычка успешно закреплена — Вы выполнили её 10 раз подряд! 💪\n"
